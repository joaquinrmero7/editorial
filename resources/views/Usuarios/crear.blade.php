            ...
            <div class="row">
                <div class="panel panel-default" id="panel-profin" style="margin-top:20px;">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"  action="{{ url('user/save') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" onkeypress="return alpha(event)" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="mlastname" type="text" onkeypress="return alpha(event)" class="form-control{{ $errors->has('mlastname') ? ' is-invalid' : '' }}" name="mlastname" value="{{ old('mlastname') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('rol') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <select name="rol" id="rol" class="form-control">
                                                ...
                                                <option value="USER_ROLE"selected="selected">Cliente</option>
                                            </select>
