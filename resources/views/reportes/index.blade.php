            ...
            <div class="">
                <div class="panel panel-default" id="panel-profin" style="margin-top:20px;">
                    ...
                    <div class="panel-body">
                        <div class="col-md-3">
                            <a href="{{ url("generareporte/1") }}" class="btn btn-primary">
                                <i class="fa fa-btn fa-user"></i> Generar Reporte Ventas Diarias
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ url("generareporte/2") }}" class="btn btn-primary">
                                <i class="fa fa-btn fa-user"></i> Generar Reporte Ventas Mensuales
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ url("generareporte/3") }}" class="btn btn-primary">
            ...
            <div class="">
                <div class="panel panel-default" id="panel-profin" style="margin-top:20px;">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-3">
                            <a href="{{ url("reportesFecha/desde/hasta") }}"class="btn btn-primary" id="reportes">
                                <i class="fa fa-btn fa-user"></i> Generar Reporte Ventas Anuales
                            </a>
                        </div>
                    </div>
