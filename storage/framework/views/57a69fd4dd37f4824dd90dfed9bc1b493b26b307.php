            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="mlastname" class="col-md-4 col-form-label text-md-right">Apellido Materno</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="departamento" type="text" class="form-control<?php echo e($errors->has('departamento') ? ' is-invalid' : ''); ?>" name="departamento" value="<?php echo e(old('departamento')); ?>">
