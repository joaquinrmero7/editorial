       ...
       <div class="row">
           <div class="panel panel-default" id="panel-profin" style="margin-top:20px;">
               <div class="panel-heading">
                   <h3 class="panel-title" style="text-align: center">Modificar Proveedor</h3>
               </div>
               <div class="panel-body">
                     ...
                     <?php endif; ?>
                     <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="<?php echo e(url('proveedores/'. $proveedor->id)); ?>">
                        <?php echo e(csrf_field()); ?>
                             ...
                             <div class="form-group <?php echo e($errors->has('tittle') ? ' has-error' : ''); ?>">
                                 ...
                                 <div class="col-md-6">
                                     <input id="tittle" type="text" class="form-control" name="tittle" required value="<?php echo e($proveedor->nombre); ?>">
                             ...
                             <div class="form-group <?php echo e($errors->has('direccion') ? ' has-error' : ''); ?>">
                                 ...
                                 <div class="col-md-6">
                                    <input id="direccion" type="text" class="form-control" name="direccion" required value="<?php echo e($proveedor->direccion); ?>">
                             ...
                             <div class="form-group <?php echo e($errors->has('nit') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                   <input id="nit" type="text" class="form-control" name="nit" required value="<?php echo e($proveedor->nit); ?>">
                            ...
                            <div class="form-group <?php echo e($errors->has('telefonos') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                   <input id="telefonos" type="text" class="form-control" name="telefonos" required value="<?php echo e($proveedor->telefono); ?>">
                     ...
                     <?php if($success): ?>
                         <div class="alert alert-success">
                             <strong>!!Felicidades!!</strong> Se modifico el Proveedor Correctamente <br><br>
                         </div>
                     <?php endif; ?>
                </div>
           </div>
