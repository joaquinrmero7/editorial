<?php $__env->startSection('content'); ?>
    <div id="ribbon">
        <ol class="breadcrumb">
            ...
            <li>Modificar Tipo de Producto</li>
        </ol>
    </div>
       ...
       <div class="row">
           <div class="panel panel-default" id="panel-profin" style="margin-top:20px;">
               <div class="panel-heading">
                   <h3 class="panel-title" style="text-align: center">Modificar Tipo de Producto</h3>
               </div>
               <div class="panel-body">
                     ...
                     <?php endif; ?>
                         <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="<?php echo e(url('categorias/'. $categoria->id)); ?>">
                             ...
                             <div class="form-group <?php echo e($errors->has('tittle') ? ' has-error' : ''); ?>">
                                 ...
                                 <div class="col-md-6">
                                     <input id="tittle" type="text" class="form-control" name="tittle" required value="<?php echo e($categoria->nombre); ?>">
                             ...
                             <div class="form-group">
                                 <div class="col-md-6 col-md-offset-4">
                                   <button type="submit" class="btn btn-primary btn-block">
                                       <i class="fa fa-btn fa-user"></i> Modificar Tipo de Producto
                                   </button>
                                 </div>
                             </div>
                         </form>
                     ...
                     <?php if($success): ?>
                         <div class="alert alert-success">
                             <strong>!!Felicidades!!</strong>Se Modifico el Tipo de Producto Correctamente <br><br>
                         </div>
                     <?php endif; ?>
                </div>
           </div>
