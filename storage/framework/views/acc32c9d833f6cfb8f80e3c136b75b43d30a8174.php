<?php $__env->startSection('content'); ?>
    <div id="ribbon">
        <ol class="breadcrumb">
            <li>Inicio</li><li>Crear Usuario</li>
        </ol>
    </div>
    <div class="container">
            <div class="row">
                <div class="panel panel-default" id="panel-profin" style="margin-top:20px;">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="text-align: center">Crear Usuario</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <?php endif; ?>
                        <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"  action="<?php echo e(url('user/save')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" onkeypress="return alpha(event)" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name" value="<?php echo e(old('name')); ?>" required autofocus>
                            ...
                            <div class="form-group row">
                                <label for="mlastname" class="col-md-4 control-label">Apellido Materno</label>
    
                                <div class="col-md-6">
                                    <input id="mlastname" type="text" onkeypress="return alpha(event)" class="form-control<?php echo e($errors->has('mlastname') ? ' is-invalid' : ''); ?>" name="mlastname" value="<?php echo e(old('mlastname')); ?>" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="departamento" type="text" class="form-control<?php echo e($errors->has('departamento') ? ' is-invalid' : ''); ?>" name="departamento" value="<?php echo e(old('departamento')); ?>" required autofocus>
                            ...
                            <div class="form-group<?php echo e($errors->has('rol') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <select name="rol" id="rol" class="form-control">
                                                ...
                                                <option value="VENDEDOR_ROLE">Cajero</option>
                                                <option value="USER_ROLE"selected="selected">Cajero con inclusión</option>
                                            </select>
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary btn-block">
                                    <i class="fa fa-btn fa-user"></i> Crear Usuario
                                </button>
                                </div>
                            </div>
                        </form>
