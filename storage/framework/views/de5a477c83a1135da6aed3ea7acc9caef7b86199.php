<?php $__env->startSection('content'); ?>
    <div class="album py-5 bg-light">
        <div class="container">
            <?php if($key == 1): ?>
                <h3>Productos del Tipo de producto: <strong><?php echo e($libros[0]->categoria->nombre); ?></strong></h3>
            <?php endif; ?>
            <div class="row">
                <?php $__currentLoopData = $libros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3">
                        <div class="card mb-4 box-shadow">
                            <a href="<?php echo e(url('libro/'.$l->id)); ?>"><img class="card-img-top" src="<?php echo e(url('imagen/'.$l->image)); ?>" alt="Card image cap"></a>
                            <div class="card-body">
                            <h4>
