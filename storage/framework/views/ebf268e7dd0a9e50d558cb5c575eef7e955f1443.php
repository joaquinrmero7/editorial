        ...
        <div class="row">
            <div class="table-responsive">
                <div class="panel panel-default" id="panel-profin" style="margin-top:20px;">
                    <div class="panel-heading textoHeader">Libros Creados</div>
                    <div class="panel-body">
                        <div>
                            <h3 class="pull-left">Existen <?php echo e($libros->total()); ?> Libros</h3>
                            <a href="<?php echo e(url('libros/create')); ?>" class="btn btn-info pull-right" >Crear Libro</a>
                        </div>
