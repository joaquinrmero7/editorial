       ...
       <div class="row">
           <div class="panel panel-default" id="panel-profin" style="margin-top:20px;">
               <div class="panel-heading">
                   <h3 class="panel-title" style="text-align: center">Editar Libro</h3>
               </div>
               <div class="panel-body">
                     ...
                     <?php endif; ?>
                        <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="<?php echo e(url('libros/'. $libro->id)); ?>">
                        <?php echo e(csrf_field()); ?>
                             ...
                             <div class="form-group <?php echo e($errors->has('tittle') ? ' has-error' : ''); ?>">
                                 ...
                                 <div class="col-md-6">
                                     <input id="tittle" type="text" class="form-control" name="tittle" required value="<?php echo e($libro->nombre); ?>">
                            ...
                            <div class="form-group <?php echo e($errors->has('autor') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-6">
                                        <input id="autor" type="text" class="form-control" name="autor" required value="<?php echo e($libro->autor); ?>">
                            ...
                            <div class="form-group <?php echo e($errors->has('precio') ? ' has-error' : ''); ?>">
                                 ...
                                 <div class="col-md-5">
                                     <input id="precio" type="text" class="form-control" name="precio" required value="<?php echo e($libro->precio); ?>">
                            ...
                            <div class="form-group <?php echo e($errors->has('stock') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-5">
                                    <input id="stock" type="number" class="form-control" name="stock" required value="<?php echo e($libro->stock); ?>">
                             ...
                             <div class="form-group">
                                 <div class="col-md-6 col-md-offset-4">
                                   <button type="submit" class="btn btn-primary btn-block">
                                       <i class="fa fa-btn fa-user"></i> Modificar Libro
                                   </button>
                                 </div>
                             </div>
                         </form>
                     ...
                     <?php if($success): ?>
                         <div class="alert alert-success">
                             <strong>!!Felicidades!!</strong>Se Modifico el Libro Correctamente <br><br>
                         </div>
                     <?php endif; ?>
                </div>
           </div>
